...
public class Utils {
    ...
    private static final String ACCENT_PREF = "com.csis4495_fall2022.lyricsai.pref_accent";
    private static final String ACCENT_VALUE = "com.csis4495_fall2022.lyricsai.pref_accent_value";
    private static final String THEME_PREF = "com.csis4495_fall2022.lyricsai.pref_theme";
    private static final String THEME_VALUE = "com.csis4495_fall2022.lyricsai.pref_theme_value";
    private static final String SEARCH_BAR_PREF = "com.csis4495_fall2022.lyricsai.pref_search_bar";
    private static final String SEARCH_BAR_VALUE = "com.csis4495_fall2022.lyricsai.pref_search_bar_value";
    private static boolean globalSongFound = false;
    ...
    /*static boolean setupSearch(@NonNull final SearchView searchView, @NonNull final ArtistsAdapter artistsAdapter, @NonNull final List<Artist> artists, @NonNull final IndexBarRecyclerView indexBarRecyclerView) {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                boolean songFound = processQuery(newText, artistsAdapter, artists);
                globalSongFound = songFound;
        ...
        return globalSongFound;

    }*/


     static boolean processQuery(@NonNull final String query, @NonNull final ArtistsAdapter artistsAdapter, @NonNull final List<Artist> artists) {
